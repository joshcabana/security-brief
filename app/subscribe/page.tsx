...
export const metadata: Metadata = createPageMetadata({
  ...
  description: 'Join 4,500+ security leaders. Get weekly AI threat intelligence or upgrade to Pro for early access, threat playbooks, and vulnerability deep dives.',
});

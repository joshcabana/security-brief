      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-12">
          ...
          <aside className="space-y-6" aria-label="Article sidebar">
            ...
            <div className="p-6 rounded-xl" style={{ background: '#161b22', border: '1px solid #30363d' }}>
              <div className="text-xs font-mono uppercase tracking-widest mb-4" style={{ color: '#8b949e', letterSpacing: '0.12em' }}>Accountability</div>
              <div className="space-y-3">
                <div className="flex flex-col gap-1">
                  <span className="text-xs" style={{ color: '#484f58' }}>Reviewed by</span>
                  <span className="text-sm font-medium text-white">Josh Cabana</span>
                </div>
                <div className="flex flex-col gap-1 mt-2">
                  <span className="text-xs" style={{ color: '#484f58' }}>Verification</span>
                  <span className="text-xs leading-relaxed" style={{ color: '#8b949e' }}>Source materials reviewed. Technical exploit chains not independently reproduced.</span>
                </div>
              </div>
            </div>

...
**Pinned baseline:** `origin/main` @ `9f60eaae290c64b81e29c97cb8912ae5a3a2afed` **Last updated:** 07 April 2026 **Updated by:** Codex
...
| Latest deploy | `main` @ `9f60eaae290c64b81e29c97cb8912ae5a3a2afed` — runtime reported active deployment |
...
| Beehiiv hosted upgrade URL | ✅ Verified disabled — `https://aisec.beehiiv.com/upgrade` redirects back to the publication home page with `Paid Subscriptions are disabled.` |
...
2. **Hosted Beehiiv upgrade route is confirmed disabled, not live** — The public `https://aisec.beehiiv.com/upgrade` endpoint currently redirects with `Paid Subscriptions are disabled.`, so there is no active paid-offer page to verify yet.
